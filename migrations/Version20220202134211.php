 ...
 */
final class Version20220202134211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE decription description VARCHAR(255) NOT NULL');
    }
